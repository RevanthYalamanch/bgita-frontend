export const LESSON_DATA = [
  ...
  },
  {
    ...
    exercise_instructions: "1. Write down one harsh or critical 'Automatic Negative Thought' you had today.\n2. Identify the distortion (e.g., Catastrophizing, Mind-Reading, All-or-Nothing).\n3. Challenge it: Rewrite that exact thought as if you were speaking to someone you deeply care about.",
  ...
  },
  {
    ...
    exercise_instructions: "Think of a recent emotional overreaction.\n1. The Consequence: What did you do or feel at the very end?\n2. The Trigger: What was the exact event that started it?\n3. The Missing Links: List the specific thoughts and feelings that connected the Trigger to the Consequence.",
  ...
  },
  {
    ...
    exercise_instructions: "Think of a situation currently causing you anxiety.\n1. Write down 3 things about this situation that are completely OUT of your control.\n2. Write down 3 things that are completely IN your control (your actions, your effort, your response).",
  ...
  },
  {
    ...
    exercise_instructions: "Audit your last 24 hours:\n1. Sleep: How many hours did you get, and was it restful?\n2. Fuel: Did you eat regular, nourishing meals, or skip them/binge?\n3. Movement: Did you move your body today?\nIdentify one area that needs immediate stabilization.",
  ...
  },
  {
    ...
    exercise_instructions: "1. Identify a task you have been avoiding because you lack the 'motivation' to do it.\n2. Break that task down into the smallest possible step that takes less than 5 minutes.\n3. Write down the exact time and place you will complete this 5-minute step today.",
  ...
  },
  {
    ...
    exercise_instructions: "Choose a fear or situation you have been avoiding.\n1. Goal: What is the ultimate thing you are afraid to do?\n2. Step 1: What is a 2/10 anxiety version of this? (e.g., Thinking about it, or looking at a picture).\n3. Step 2: What is a 4/10 anxiety version? Build a ladder of 3 small steps.",
  ...
  },
  {
    ...
    exercise_instructions: "Practice the 5-4-3-2-1 Grounding Technique. Look around you right now and list:\n- 5 things you can see.\n- 4 things you can physically feel.\n- 3 things you can hear.\n- 2 things you can smell.\n- 1 thing you can taste.",
  ...
  },
  {
    ...
    exercise_instructions: "1. Write down a deeply held negative belief (e.g., 'I am a failure').\n2. The Prosecution: List 3 pieces of factual, objective evidence that support this belief.\n3. The Defense: List 3 pieces of factual, objective evidence that contradict this belief.",
  ...
  },
  {
    ...
    exercise_instructions: "Think of a situation where you felt like things were 'all bad' or a 'total disaster'.\n1. What is the Black/White thought?\n2. Find the Gray: What is one small thing that actually went okay, or one thing you learned from it?",
  ...
  },
  {
    ...
    exercise_instructions: "Build your Emergency Maintenance Plan:\n1. Triggers: List 3 things most likely to cause a dip in your mental health.\n2. Warning Signs: List 3 early signs that your mental health is slipping (e.g., skipping meals, isolating).\n3. Coping Strategies: List 3 non-negotiable actions you will take when you notice those warning signs.",
