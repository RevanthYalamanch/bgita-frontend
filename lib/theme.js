...
//
// Identity: calm, clinical, restrained motion, a single deep-teal accent, Inter
// typography. Light = off-white canvas + white cards + hairline slate borders.
...
export const fx = {
  ...
  pageBackground: `radial-gradient(1100px 700px at 50% -15%, rgba(13, 148, 136, 0.06), transparent 55%),
     ${tokens.bg}`,
  // Card with a hairline border and soft, low elevation (no glassy blur).
  glassCard: {
